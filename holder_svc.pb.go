...
const file_payday_holder_svc_proto_rawDesc = "" +
	...
	"\x06tenant\x18\x02 \x01(\v2\x11.payday.TenantRefR\x06tenant\"v\n" +
	"\tHolderRef\x12\x10\n" +
	"\x02id\x18\x01 \x01(\fH\x00R\x02id\x12-\n" +
	"\x04slug\x18\x04 \x01(\v2\x17.payday.HolderRefBySlugH\x00R\x04slug\x12!\n" +
	...
	"\x06select\x18\x02 \x01(\v2\x14.payday.HolderSelectR\x06select\"\xaa\x03\n" +
